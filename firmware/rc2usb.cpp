...
class HidRcJoyDevice : public UsbCdcDeviceT<HidRcJoyDevice>
{
    using base = UsbCdcDeviceT<HidRcJoyDevice>;
...
private:
    ...
    void OnEventControlLineStateChanged()
    {
        ...
        ResetToBootloader(GetBaudRate() == 1200 && !IsDtrActive());
    }
    ...
    RequestStatus GetDescriptor(const UsbRequest& request)
    {
        ...
        case UsbDescriptorTypeString:
        {
            ...
            {
                static const char product[] PROGMEM = "RC to USB Joystick";
